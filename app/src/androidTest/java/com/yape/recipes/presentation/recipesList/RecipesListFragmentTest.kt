...
class RecipesListFragmentTest {
    ...
    fun testSearchRecipePerName(){
        ...
        onView(ViewMatchers.withId(R.id.search_view)).perform(click())
        onView(ViewMatchers.withId(R.id.search_view)).perform(typeSearchViewText("receita"))
    ...
    fun testSearchRecipePerIngredient(){
        ...
        onView(ViewMatchers.withId(R.id.search_view)).perform(click())
        onView(ViewMatchers.withId(R.id.search_view)).perform(typeSearchViewText("cebolla"))
